...
def generate_brief_template():
    ...
    doc.add_paragraph(
        "Brief background on the customer relationship and current status.",
        style="Normal",
    )
    ...
    doc.add_paragraph(
        "Prepared discussion topics for the meeting.", style="List Number"
    )
...
def generate_technical_template():
    """Multi-page technical doc with rule under H1, code blocks."""
    doc = Document()
    ...
    doc.add_paragraph(
        "Explanation of the current system design and its limitations.", style="Normal"
    )
    ...
    doc.add_paragraph(
        "Detailed technical analysis with supporting data.", style="Normal"
    )
    ...
    doc.add_paragraph("Important note or caveat about the analysis.", style="Quote")
...
def generate_report_template():
    """Formal multi-page report with cover section, header, page numbers."""
    doc = Document()
    configure_base_styles(doc, tight_spacing=False)
    ...
    doc.add_paragraph(
        "Summary of current deployment state and changes.", style="Normal"
    )
    ...
    doc.add_paragraph(
        "Analysis of feature adoption and usage patterns.", style="Normal"
    )
...
def generate_proposal_template():
    ...
    doc.add_paragraph(
        "Description of the technical solution architecture.", style="Normal"
    )

    doc.add_paragraph("Security & Compliance", style="Heading 2")
    doc.add_paragraph(
        "Security posture, certifications, and compliance details.", style="Normal"
    )
    ...
    sample_data = [
        ...
        [
            "REQ-002",
            "Must provide OTA updates",
            "Esper Airwave provides...",
            "Compliant",
        ],
